                        ...
                        <div style="display: flex; align-items: center;"
                            ...
                            <a wire:navigate
                               ...
                               style="text-decoration: none; display: block; text-overflow: ellipsis; white-space: nowrap; overflow: hidden;">
                                ...
                                <div style="display: flex; align-items: center;" class="gap-x-2">
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="20" height="20" viewBox="0 0 24 15" stroke-width="1.5" stroke="currentColor" class="size-6">
